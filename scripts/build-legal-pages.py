...
<html lang="{{ html_lang }}">
  <head>
    ...
    {%% require_css %%}
      <style>
        .legal-doc {
          --ink: #1f2937; --muted: #6b7280; --rule: #e5e7eb; --accent: #1d4ed8;
          max-width: 46rem; margin: 0 auto; padding: 3rem 1.25rem 5rem;
          color: var(--ink); line-height: 1.65;
          font-family: system-ui, -apple-system, "Segoe UI", sans-serif;
        }
        .legal-doc h1 { font-size: 2rem; line-height: 1.2; margin: 0 0 1.5rem; letter-spacing: -0.02em; }
        ...
        .legal-doc code { background: #f3f4f6; padding: 0.1em 0.35em;
        ...
        @media (prefers-color-scheme: dark) {
          .legal-doc { --ink: #e5e7eb; --muted: #9ca3af; --rule: #374151; --accent: #93b4fd; }
          .legal-doc code { background: #1f2937; }
          .legal-doc th { background: #1f2937; }
          .legal-doc blockquote { background: #111827; }
        }
      </style>
    {%% end_require_css %%}
  </head>
